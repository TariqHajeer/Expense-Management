...
@DatabaseView(
        "SELECT o.id as id,o.material_id as material_id,o.outlayOwner_id as outlayOwner_id,o.price as price ,m.name as material_name,oo.name as outlayOwner_name " +
                "From Outlay o " +
                "JOIN Material m " +
