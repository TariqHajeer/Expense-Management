...
@DatabaseView(
        "SELECT o.id as id,o.description as description,o.material_id as material_id,o.outlayOwner_id as outlayOwner_id,o.price as price,o.date as date ,m.name as material_name,m.isService as isService,oo.name as outlayOwner_name " +
                "From Outlay o " +
                "JOIN Material m " +
